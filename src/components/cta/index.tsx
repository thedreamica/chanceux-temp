  ...
  return (
    <div className="flex flex-col sm:flex-row justify-between items-center w-full px-6 sm:px-40 py-10 gap-10">
      <div className="w-full sm:w-1/3">
        <p className="text-white text-4xl sm:text-5xl font-semibold mb-10 sm:mb-20">
      ...
      <img className="w-full h-full sm:w-1/2 sm:h-1/2 object-cover" src="static\images\landing\cta_bg.png" />
    </div>
  );
};
